 ...
 * \author Jeff Ferr
 */
class DatagramSocket6 : public jnetwork::Connection {
  ...
  public:
     ...
     *
     */
    DatagramSocket6(std::string addr, int port, bool stream = false, std::chrono::milliseconds timeout = std::chrono::milliseconds(0), int rbuf = SOCK_RD_BUFFER_SIZE, int wbuf = SOCK_WR_BUFFER_SIZE);

    /**
     * \brief Construtor UDP server.
     *
     */
    DatagramSocket6(int port, bool stream = false, std::chrono::milliseconds timeout = std::chrono::milliseconds(0), int rbuf = SOCK_RD_BUFFER_SIZE, int wbuf = SOCK_WR_BUFFER_SIZE);

    /**
     * \brief Construtor UDP server.
     *
     */
    DatagramSocket6(InetAddress *addr,int port, bool stream = false, std::chrono::milliseconds timeout = std::chrono::milliseconds(0), int rbuf = SOCK_RD_BUFFER_SIZE, int wbuf = SOCK_WR_BUFFER_SIZE);
