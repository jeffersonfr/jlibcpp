...
{
	jcommon::Object::SetClassName("jmedia::MediaException");
}

MediaException::MediaException(std::string reason_):
	jcommon::RuntimeException(reason_)
{
	jcommon::Object::SetClassName("jmedia::MediaException");
}

MediaException::MediaException(jcommon::Exception *exception, std::string reason_):
