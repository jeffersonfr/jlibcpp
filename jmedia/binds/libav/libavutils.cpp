                         ...
                         const char *arg)
{
    ...
    l->groups = (OptionGroup*)GROW_ARRAY(l->groups, l->nb_groups);
                    ...
                    const char *key, const char *val)
{
    ...
    g->opts = (Option*)GROW_ARRAY(g->opts, g->nb_opts);
                               ...
                               const OptionGroupDef *groups, int nb_groups)
{
    ...
    octx->groups    = (OptionGroupList *)av_mallocz(sizeof(*octx->groups) * octx->nb_groups);
    if (!octx->groups)
        exit_program(1);
