 ...
 ***************************************************************************/
#ifndef J_DFBLIGHTPLAYER_H
#define J_DFBLIGHTPLAYER_H
...
class DFBLightPlayer : public jmedia::Player, public jthread::Thread {
	...
	public:
		 ...
		 *
		 */
		DFBLightPlayer(std::string file);

		/**
		 * \brief
		 *
		 */
		virtual ~DFBLightPlayer();
