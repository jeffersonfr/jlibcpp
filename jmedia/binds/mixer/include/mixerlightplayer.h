 ...
 ***************************************************************************/
#ifndef J_MIXERLIGHTPLAYER_H
#define J_MIXERLIGHTPLAYER_H
...
class MixerLightPlayer : public jmedia::Player {
	...
	public:
		 ...
		 *
		 */
		MixerLightPlayer(jnetwork::URL url);

		/**
		 * \brief
		 *
		 */
		virtual ~MixerLightPlayer();
