...
ConnectionTimeoutException::ConnectionTimeoutException(std::string reason_):
  jexception::TimeoutException(reason_)
{
  jcommon::Object::SetClassName("jexception::ConnectionTimeoutException");
}

ConnectionTimeoutException::ConnectionTimeoutException(jexception::Exception *exception, std::string reason_):
  jexception::TimeoutException(exception, reason_)
{
  jcommon::Object::SetClassName("jexception::ConnectionTimeoutException");
}

ConnectionTimeoutException::~ConnectionTimeoutException() throw()
{
}
