...
SRCS  = \
  $(addprefix jcommon/,$(OBJS_jcommon)) \
  $(addprefix jevent/,$(OBJS_jevent)) \
  $(addprefix jexception/,$(OBJS_jexception)) \
  $(addprefix jmath/,$(OBJS_jmath)) \
  $(addprefix jio/,$(OBJS_jio)) \
  $(addprefix jresource/,$(OBJS_jresource)) \
  $(addprefix jsecurity/,$(OBJS_jsecurity)) \
  $(addprefix jshared/,$(OBJS_jshared)) \
  $(addprefix jnetwork/,$(OBJS_jnetwork)) \
