...
template<class T> class Math : public virtual jcommon::Object {
  ...
  public:
    ...
    inline static const double ln10 = 2.30258509299404568402;
    /** \brief Log of e */
    inline static const double logE = 0.43429448190325182765;
    /** \brief Velocity of light (m s^-1) */
    inline static const double C = 2.99792458e8;
    /** \brief Error */
    inline static const double Cuncertainty = 0.0;
    /** \brief Gravitational constant (m^3 kg^-1 s^-1) */
    inline static const double G = 6.673e-11;
    /** \brief Error */
    inline static const double Guncertainty = 0.010e-11;
    /** \brief (GeV/c^-2)^-2 */
    inline static const double GhbarC = 6.707e-39;
    /** \brief Error */
    inline static const double GhbarCuncertainty = 0.010e-39;
    /** \brief Standard acceleration of gravity (m s^-2) */
    inline static const double Gn = 9.80665;
    /** \brief Error */
    inline static const double GnUncertainty = 0.0;
    /** \brief Planck's constant (J s) */
    inline static const double H = 6.62606876e-34;
    /** \brief */
    inline static const double HUncertainty = 0.00000052e-34;
    /** \brief h-bar (h over 2 pi) (J s) */
    inline static const double Hbar = 1.054571596e-34;
    /** \brief Error */
    inline static const double HbarUncertainty = 0.000000082e-34;
    /** \brief Boltzmann's constant (J K^-1) */
    inline static const double K = 1.3806503e-23;
    /** \brief */
    inline static const double KUncertainty = 0.0000024e-23;
    /** \brief Stefan-Boltzmann constant (W m^-2 K^-4) */
    inline static const double Sigma = 5.6704e-8;
    /** \brief Error */
    inline static const double SigmaUncertainty = 0.000040e-8;
    /** \brief Avogadro constant (Avogadro's Number) (mol^-1) */
    inline static const double Na = 6.02214199e+23;
    /** \brief Error */
    inline static const double NaUncertainty = 0.00000047e+23;
    /** \brief universal gas constant (Na * K) (J K^-1 mol^-1) */
    inline static const double R = K*Na;
    /** \brief */
    inline static const double RUncertainty = R * ((KUncertainty / K) + (NaUncertainty / Na));
    /** \brief Molecular weight of dry air (kg kmol^-1 (or gm mol^-1)) */
    inline static const double MWair = 28.9644;
    /** \brief Dry Air Gas Constant (R / MWair) (J kg^-1 K^-1) */
    inline static const double Rgair = (1000.0 * R) / MWair;
    /** \brief Elementary charge (C) */
    inline static const double Qe = 1.602176462e-19;
    /** \brief Error */
    inline static const double QeUncertainty = 0.000000063e-19;
     ...
     *
     */
    static uint64_t Hash(const char *txt)
    {
     ...
     *
     */
    static T * Normal2Plane(const T p1[3], const T p2[3], const T p3[3], T normal[3])
    {
     ...
     *
     */
    static double Voigt(double xx, double sigma, double lg, int R = 4)
    {
