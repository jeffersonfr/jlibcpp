...
void Application::RegisterWidgetListener(WidgetListener *listener)
{
	if (listener == NULL) {
		return;
	}
...
void Application::RemoveWidgetListener(WidgetListener *listener)
{
	if (listener == NULL) {
		return;
	}
...
void Application::DispatchWidgetEvent(WidgetEvent *event)
{
	if (event == NULL) {
		return;
	}
...
std::vector<WidgetListener *> & Application::GetWidgetListeners()
{
