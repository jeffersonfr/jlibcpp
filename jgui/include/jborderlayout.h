...
enum jborderlayout_align_t {
	...
	JBA_WEST,
	JBA_CENTER,
	JBA_BEFORE_FIRST_LINE,
	JBA_AFTER_LAST_LINE,
	JBA_BEFORE_LINE_BEGINS,
	JBA_AFTER_LINE_ENDS,
	JBA_PAGE_START = JBA_BEFORE_FIRST_LINE,
	JBA_PAGE_END = JBA_AFTER_LAST_LINE,
	JBA_LINE_START = JBA_BEFORE_LINE_BEGINS,
	JBA_LINE_END = JBA_AFTER_LINE_ENDS
};
