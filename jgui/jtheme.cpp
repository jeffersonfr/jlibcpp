	...
	jcommon::Object()
{
	...
	SetWindowBackgroundColor(0x00, 0x00, 0x00, 0xff);
	SetWindowForegroundColor(0xf0, 0xf0, 0xf0, 0xff);
	SetWindowBorderColor(0xf0, 0xf0, 0xf0, 0xff);

	SetComponentBackgroundColor(0x00, 0x00, 0x00, 0xff);
	SetComponentForegroundColor(0xf0, 0xf0, 0xf0, 0xff);
	SetComponentBackgroundFocusColor(0xf0, 0xf0, 0xf0, 0xff);
	SetComponentForegroundFocusColor(0x00, 0x00, 0x00, 0xff);
	SetComponentBorderColor(0x80, 0x80, 0x80, 0xff);
	SetComponentBorderFocusColor(0xf0, 0xf0, 0xf0, 0xff);
	SetComponentScrollbarColor(0x40, 0x40, 0x40, 0xff);
	SetComponentDisabledBackgroundColor(0x00, 0x00, 0x00, 0xff);
	SetComponentDisabledForegroundColor(0x80, 0x80, 0x80, 0xff);
	SetComponentDisabledBorderColor(0x80, 0x80, 0x80, 0xff);
	
	SetItemColor(0x00, 0x00, 0x00, 0xff);
	SetItemForegroundColor(0xf0, 0xf0, 0xf0, 0xff);
	SetItemFocusColor(0x40, 0x40, 0x40, 0xff);
	SetItemForegroundFocusColor(0xf0, 0xf0, 0xf0, 0xff);
	SetSelectedItemColor(0x20, 0x20, 0x20, 0xff);
	SetSelectedItemForegroundColor(0x0, 0x80, 0x80, 0xff);
	SetDisabledItemColor(0x10, 0x10, 0x10, 0xff);
