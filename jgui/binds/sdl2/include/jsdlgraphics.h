 ...
 ***************************************************************************/
#ifndef J_SDLGRAPHICS_H
#define J_SDLGRAPHICS_H
 ...
 * \author Jeff Ferr
 */
class SDLGraphics : public virtual jgui::Graphics{
	...
	public:
		 ...
		 *
		 */
		SDLGraphics(void *surface, jpixelformat_t pixelformat, int wp, int hp);
