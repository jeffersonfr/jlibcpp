 ...
 ***************************************************************************/
#ifndef J_GTKGRAPHICS_H
#define J_GTKGRAPHICS_H
 ...
 * \author Jeff Ferr
 */
class GTKGraphics : public virtual jgui::Graphics{
	
	friend class GTKImage;
	...
	public:
		 ...
		 *
		 */
		GTKGraphics(void *surface, jpixelformat_t pixelformat, int wp, int hp);
