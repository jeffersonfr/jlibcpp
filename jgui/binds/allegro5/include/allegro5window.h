 ...
 ***************************************************************************/
#ifndef J_ALLEGRO5WINDOW_H
#define J_ALLEGRO5WINDOW_H
 ...
 * \author Jeff Ferr
 */
class Allegro5Window : public jgui::Window {
	...
	public:
		 ...
		 *
		 */
		Allegro5Window(int x, int y, int width, int height);
		
		/**
		 * \brief
		 *
		 */
		virtual ~Allegro5Window();
