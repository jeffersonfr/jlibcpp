 ...
 ***************************************************************************/
#ifndef J_DIRECTFBWINDOW_H
#define J_DIRECTFBWINDOW_H
 ...
 * \author Jeff Ferr
 */
class DirectFBWindow : public jgui::Window {
	...
	public:
		 ...
		 *
		 */
		DirectFBWindow(int x, int y, int width, int height);
		
		/**
		 * \brief
		 *
		 */
		virtual ~DirectFBWindow();
