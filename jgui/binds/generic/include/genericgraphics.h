 ...
 ***************************************************************************/
#ifndef J_GENERICGRAPHICS_H
#define J_GENERICGRAPHICS_H
 ...
 * \author Jeff Ferr
 */
class GenericGraphics : public jgui::Graphics{
	
	friend class GenericImage;
	friend class GenericPath;
	friend class Window;
	...
	public:
		 ...
		 *
		 */
		GenericGraphics(void *surface, cairo_t *cairo_context, jpixelformat_t pixelformat, int wp, int hp);
