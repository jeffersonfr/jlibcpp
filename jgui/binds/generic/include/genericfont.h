 ...
 ***************************************************************************/
#ifndef J_GENERICFONT_H
#define J_GENERICFONT_H
 ...
 * \author Jeff Ferr
 */
class GenericFont : public jgui::Font{

	friend class GenericGraphics;
	...
	public:
		 ...
		 *
		 */
		GenericFont(std::string name, jfont_attributes_t attributes, int size);
