		...
		virtual void Paint(jgui::Graphics *g)
		{
			...
			for (int k=0,j=-1; j<=1; k++,j++) {
				...
				for (int i=0; i<3; i++) {
					...
					g->DrawImage("icons/square.png", (int)(x+translate_x+(i+k*3)*box_width), y+translate_y+0*box_height);
					g->DrawImage("icons/square.png", (int)(x+translate_x+(i+k*3)*box_width), y+translate_y+1*box_height, image_width, image_height);
					g->DrawImage("icons/square.png", 32, 32, 32, 32, (int)(x+translate_x+(i+k*3)*box_width), y+translate_y+2*box_height);
					g->DrawImage("icons/square.png", 32, 32, 32, 32, (int)(x+translate_x+(i+k*3)*box_width), y+translate_y+3*box_height, image_width, image_height);
