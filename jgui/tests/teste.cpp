...
class GraphicPanel : public jgui::Canvas{
	...
	virtual void Paint(jgui::Graphics *g)
	{
		...
		jgui::Font *f1 = jgui::Font::CreateFont(jcommon::System::GetResourceDirectory() + "/fonts/font.ttf", jgui::JFA_NONE, 50),
			*f2 = jgui::Font::CreateFont(jcommon::System::GetResourceDirectory() + "/fonts/font.ttf", jgui::JFA_NONE, 40),
			*f3 = jgui::Font::CreateFont(jcommon::System::GetResourceDirectory() + "/fonts/font.ttf", jgui::JFA_NONE, 30),
			*f4 = jgui::Font::CreateFont(jcommon::System::GetResourceDirectory() + "/fonts/font.ttf", jgui::JFA_NONE, 20);
		int shadow = 4;
